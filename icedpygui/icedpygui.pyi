...
def add_button(
    ...
    ----------
        ...
        on_press: Callable
            Sets the callback that will be produced when the Button is pressed.
        ...
        style_standard: Optional[class]
            IpgStyleStandard: Primary, Secondary, Success, Danger, Warning, Text, Subtle
