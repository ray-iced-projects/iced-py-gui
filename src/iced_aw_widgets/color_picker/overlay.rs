...
use super::color_utils::{HexString, Hsv};
use super::overlay_position::Position;
use super::style;
use super::style::Style;
use super::status::Status;
use super::style_state::StyleState;
...
use iced::{
    advanced::{
        ...
        Layout, Overlay, Renderer as RendererTrait, Shell, Text, Widget,
    },
    ...
    Alignment, Border, Color, Element, Event, Length, Padding, Pixels, Point, Rectangle, Size, Vector,
};
    ...
    'b: 'a,
{
    ...
    pub fn new(
        ...
        let cancel_content = "✕".to_string();
        let cancel_font = iced::Font::DEFAULT;
        let submit_content = "✓".to_string();
        let submit_font = iced::Font::DEFAULT;
