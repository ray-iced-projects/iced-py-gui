...
class ButtonStyle:
    ...
    def bkg_rgba(self, rgba: list[float]) -> "ButtonStyle": ...
    # text colour
    def text_color(self, rgba: list[float]) -> "ButtonStyle": ...
    def text_color_active(self, rgba: list[float]) -> "ButtonStyle": ...
    def text_color_hovered(self, rgba: list[float]) -> "ButtonStyle": ...
    def text_color_pressed(self, rgba: list[float]) -> "ButtonStyle": ...
    def text_color_disabled(self, rgba: list[float]) -> "ButtonStyle": ...
    # text alignment
    ...
    def border_radius(self, radius: float | list[float]) -> "ButtonStyle": ...
    def border_color(self, rgba: list[float]) -> "ButtonStyle": ...
    def border_color_active(self, rgba: list[float]) -> "ButtonStyle": ...
    def border_color_hovered(self, rgba: list[float]) -> "ButtonStyle": ...
    def border_color_pressed(self, rgba: list[float]) -> "ButtonStyle": ...
    def border_color_disabled(self, rgba: list[float]) -> "ButtonStyle": ...
    # gradient
    def gradient_rgba_stops(self, stops: list[list[float]]) -> "ButtonStyle": ...
    def gradient_offset_stops(self, offsets: list[float]) -> "ButtonStyle": ...
    def gradient_degrees(self, degrees: float) -> "ButtonStyle": ...
    def gradient_radians(self, radians: float) -> "ButtonStyle": ...
    # shadow
    def shadow(self, rgba: list[float], offset_xy: list[float], blur: float) -> "ButtonStyle": ...
    def shadow_color(self, rgba: list[float]) -> "ButtonStyle": ...
    def shadow_offset(self, offset_xy: list[float]) -> "ButtonStyle": ...
