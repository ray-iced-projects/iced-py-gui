...
pub fn text_input_callback(state: &mut IpgState, id: usize, message: TIMessage) {
    ...
    match message {
        TIMessage::OnInput(value) => {
            ...
            invoke_callback_with_args(id, CallbackName::OnInput, "TextInput", value,
        ...
        TIMessage::OnSubmit(value) => {
            ...
            invoke_callback_with_args(id, CallbackName::OnSubmit, "TextInput", value,
                "def cb(wid: int, value: str)");
        }
        TIMessage::OnPaste(value) => {
            ...
            invoke_callback_with_args(id, CallbackName::OnPaste, "TextInput", value,
                "def cb(wid: int, value: str)");
        }
...
impl WidgetParamUpdate for TextInput {
    ...
    fn param_update(&mut self, param: Self::Param, value: &PyObject) {
        match param {
            ...
            TextInputParam::Show => set_t_value(&mut self.show, value, "TextInputParam::Show"),
