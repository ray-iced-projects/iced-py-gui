...
def on_stop(timer_id: int, _elapsed: int):
    update_widget(timer_id, IpgCanvasTimerParam.Label, "Start Timer")
...
def on_tick(timer_id: int, elapsed: int):
    ...
    update_canvas_item(earth_id, IpgCanvasGeometryParam.Position, earth_point)
    update_canvas_item(earth_id, IpgCanvasGeometryParam.Rotation, earth_rotation)
...
earth_id = add_canvas_image(canvas_id="canvas",
...
moon_id = add_canvas_image(canvas_id="canvas",
...
earth_obit_id = add_circle(canvas_id="canvas",
               position_xy=(canvas_width/2.0, canvas_height/2.0),
               radius=150.0,
               stroke_width=1.0,
