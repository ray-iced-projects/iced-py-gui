...
// pub fn measure_text(font_name: &String, font_size: f32, text: &str) -> (f32, f32) {
//     let f_size = if font_size > 0.0 {
//         font_size
//     } else {
//         eprint!("[WARN] font size is 0.0 at measure_text");
//         12.0
//     };
    
//     let font_result = get_font(font_name.clone());
//     let font = match font_result {
//         Ok(f) => f,
//         Err(_) => panic!("Unable to get font using {}", font_name),
//     };
//     let mut layout = fontdue::layout::Layout::new(fontdue::layout::CoordinateSystem::PositiveYDown);
//     layout.append(&[font], &fontdue::layout::TextStyle::new(text, f_size, 0));
