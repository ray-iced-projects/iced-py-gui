...
news_bold_italic_id = add_font_style(family_name="Newsreader 14pt", weight=FontWeight.Bold, style=FontStyle.Italic)
    ...
    with Row(fill=True):
        ...
        with Column(width=250.0, height_fill=True, 
            ...
            with Column(width_fill=True, spacing=10.0):
                ...
                add_text(content="Newsreader Regular (loaded via load_font)", font_id=news_regular_id)
                add_text(content="Newsreader Bold Italic (loaded via load_font)", font_id=news_bold_italic_id)
        ...
        with Column(width=350, height_fill=True, spacing=10.0, padding=[20.0]):
            ...
            with Column(fill=True, spacing=20.0):
                ...
                add_radio(labels=["shrink (default)", "fill-for text same as shrink unless using aligh right", "fixed=100.0"],
        ...
        with Column(spacing=20.0, padding=[10.0], fill=True):
            ...
            with Column(spacing=10.0, padding=[10.0], fill=True):
                ...
                add_text(content="This text was set by the color parameter", color=Color.LIGHT_GREEN)
