...
#[pyo3(signature = (
    ...
    bkg_rgba=None,
    bkg_gradient_color_stop=None,
    bkg_gradient_color_stop_alpha=None,
    bkg_gradient_rgba_stop=None,
    bkg_gradient_degrees=None,
    bkg_gradient_radians=None,
    bkg_gradient_alpha=None,
    border_color=None,
...
pub fn add_container_style(
    ...
    bkg_gradient_color_stop: Option<Color>,
    bkg_gradient_color_stop_alpha: Option<f32>,
    bkg_gradient_rgba_stop: Option<[f32; 4]>,
    bkg_gradient_degrees: Option<f32>,
    bkg_gradient_radians: Option<f32>,
    bkg_gradient_alpha: Option<f32>,
    ...
    ) -> PyResult<usize>
{
    ...
    state.widgets.insert(id, Widgets::ContainerStyle(
        ContainerStyle {
            ...
            bkg_gradient_color_stop_alpha,
            bkg_gradient_rgba_stop,
            bkg_gradient_degrees,
            bkg_gradient_radians,
            bkg_gradient_alpha,
            border_color,
            border_color_alpha, 
            border_rgba,
