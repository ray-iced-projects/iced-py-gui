...
def add_button(
    *,
    ...
    text_center : bool, optional
        Align text to center (default True).
...
def add_divider(
    ...
    """
    Adds a divider widget that allows one to change the sizes of adjacent containers.
    ...
    Args:
        ...
        sizes (list[float]): 
            The sizes (widths for horizontal, heights for vertical) of the adjacent containers.
        handle_width (float):
            Width of handle.
        handle_height (float):
            Height of handle.
        handle_offsets (list[float], optional):
            Offsets are calculated by subtracting 1/2 of the handle width or height from each size and subtracting the whole width or height from the last item in the list if used.  Supply others if this doesn't align the handle over the joint between containers.
        include_last_handle (bool, optional): Defaults to True.
            Whether to include a handle after the last container.
...
def add_pick_list(
        ...
        *,
        ...
        dynamic_closed: Optional[IpgArrow]=None,
        dynamic_opened: Optional[IpgArrow]=None,
        custom_static: Optional[IpgArrow]=None,
        style_id: Optional[int]=None,
        user_data: Optional[any]=None,
        show: bool=True,
    ) -> int:
