...
def mouse_button_pressed(_mouse_id: int, user_data: any):
    update_widget(text_for_pressed, IpgTextParam.Content, f"Button pressed")
...
def mouse_button_released(_mouse_id: int, _user_data: any):
    update_widget(text_for_released, IpgTextParam.Content, f"Button released")
