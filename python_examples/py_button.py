...
border_color_alpha = add_button_style(border_color=Color.RED,
                                      border_width=10.0,
                                      border_color_alpha=0.5)
...
def on_press(btn_id: int):
    ...
    match state["counter"]:
        ...
        case 0:
            update_widget(state["txt_id"], TextParam.Content, "Param = None, keep pressing")
        ...
        case 1:
            update_widget(state["txt_id"], TextParam.Content, "Param = Clip, keep pressing")
            update_widget_params(btn_id, {
                ButtonParam.Clip: True,
                # width needs to be set or button shrinks to size or wraps if container is smaller
                ButtonParam.Width: 75.0,
                ButtonParam.Label: "This is a clipped label"})
        case 2:
            update_widget(state["txt_id"], TextParam.Content, "Param = Height 50.0, keep pressing")
            update_widget_params(btn_id, {
                # reset some of the previous parameters
        ...
        case 3:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = Padding - all sides[20], keep pressing")
            update_widget_params(btn_id, {
                # reset some of the previous parameters
                ButtonParam.Height: None,
        ...
        case 4:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = Padding - top/bottom [20, 0, 20, 0], keep pressing")
            update_widget_params(btn_id, {
                # reset some of the previous parameters
        ...
        case 5:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = Padding - left/right [0, 20, 0, 20], keep pressing")
            update_widget_params(btn_id, {
                # reset some of the previous parameters
        ...
        case 24:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = border_rgba, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 25:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = border_radius, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 26:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = border_width, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 27:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = shadow_color, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 28:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = shadow_color alpha, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 29:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = shadow_rgba, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 30:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = shadow_offset_xy, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 31:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = shadow_blur_radius, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 32:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = text_color, keep pressing")
            update_widget_params(btn_id, {
        ...
        case 33:
            update_widget(state["txt_id"],
                          TextParam.Content,
                          "Param = text_color_alpha, keep pressing")
            update_widget_params(btn_id, {
...
with Window(title="Button Parameters",
    ...
    with Container(align_center=True, fill=True):
        with Column(spacing=20):
            state["txt_id"] = add_text(content="Default Button, press start")
