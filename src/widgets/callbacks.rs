...
//             //     return WidgetCallbackOut::default();
//             // },
//             // NOTE: Checkbox now uses direct state access in ipg_checkbox.rs
//             // NOTE: ColorPicker now uses direct state access in ipg_color_picker.rs
//             IpgWidgets::IpgColorPicker(_) => {
//                 return WidgetCallbackOut::default();
//             },
//             // NOTE: Divider now uses direct state access in ipg_divider.rs
//             IpgWidgets::IpgDividerHorizontal(_) => {
//                 return WidgetCallbackOut::default();
//             },
//             IpgWidgets::IpgDividerVertical(_) => {
//                 return WidgetCallbackOut::default();
//             },
//             // NOTE: DatePicker now uses direct state access in ipg_date_picker.rs
