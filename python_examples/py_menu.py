        ...
        with Menu(bar_spacing=10.0, item_spacings=[5.0], item_widths=[75.0], item_paddings=[5.0]):
            ...
            with MenuBarItem():
                ...
                add_button(label="New",
                           menu=True,
                           on_press=on_press,
                           user_data="New")   # dropdown item
                add_button(label="Open", menu=True,
                           on_press=on_press,
                           user_data="Open") # dropdown item
                add_button(label="Save",
                           menu=True,
                           on_press=on_press,
                           user_data="Save") # dropdown item
            ...
            with MenuBarItem():
                ...
                add_button(label="Cut",
                           menu=True,
                           on_press=on_press,
                           user_data="Cut") # dropdown item
                add_button(label="Copy",
                           menu=True,
                           on_press=on_press,
                           user_data="Copy") # dropdown item
