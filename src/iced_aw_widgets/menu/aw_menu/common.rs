...
use crate::iced_aw_widgets::menu::style::menu_bar::Catalog;
...
pub(super) struct GlobalParameters<'a, Theme: crate::iced_aw_widgets::menu::style::menu_bar::Catalog> {
...
pub(super) struct SafeTriangle {
    pub(super) p1: iced::Point,
    pub(super) p2: iced::Point,
    pub(super) p3: iced::Point,
}
...
impl SafeTriangle {
    pub(super) fn new(
        ...
        let (child_corner1, child_corner2) = match direction.0 {
            Direction::Positive => (
                iced::Point::new(child_bounds.x, child_bounds.y),
                iced::Point::new(child_bounds.x, child_bounds.y + child_bounds.height),
            ),
            Direction::Negative => (
                iced::Point::new(child_bounds.x + child_bounds.width, child_bounds.y),
                iced::Point::new(
    ...
    pub(super) fn contains(&self, point: iced::Point) -> bool {
        let sign = |p1: iced::Point, p2: iced::Point, p3: iced::Point| -> f32 {
